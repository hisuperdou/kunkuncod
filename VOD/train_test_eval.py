...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_steps', default=145875, type=int, help='train_steps')
    ...
    parser.add_argument('--epochs', default=390, type=int, help='epochs')
    parser.add_argument('--batch_size', default=8, type=int, help='batch_size')
    parser.add_argument('--stepvalue1', default=105375, type=int, help='the step 1 for adjusting lr')
    parser.add_argument('--stepvalue2', default=142125, type=int, help='the step 2 for adjusting lr')
    parser.add_argument('--stepvalue3', default=145875, type=int, help='the step 3 for adjusting lr')


    # parser.add_argument('--trainset', default='NJUD+NLPR+DUTLF-Depth', type=str, help='Trainging set')


    parser.add_argument('--trainset', default='Trainset/COD10K/', type=str, help='Trainging set')
    ...
    parser.add_argument('--save_test_path_root', default='./preds/cod10k/', type=str, help='save saliency maps path')
    parser.add_argument('--test_paths', type=str, default='COD10K-v2/testset')
    #True
    #False
    ...
    if args.Training:
        # nn.DataParallel(Training.train_net(num_gpus=num_gpus, args=args))
